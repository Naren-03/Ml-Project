...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            train_df.to_csv("train_data.csv") # type: ignore
            test_df.to_csv("test_data.csv") # type: ignore
            ...
            X_train = train_df.drop(columns = target_columns_name, axis = 1) # type: ignore
            y_train = train_df[target_columns_name]

            X_test = test_df.drop(columns = target_columns_name, axis = 1) # type: ignore
